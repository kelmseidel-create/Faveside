...
const pages = new Map([['/', 'index.html'], ['/index.html', 'index.html'], ['/index.php', 'index.html'], ['/app', 'app.html'], ['/app.html', 'app.html'], ['/app.php', 'app.html'], ['/account', 'account.html'], ['/account.html', 'account.html'], ['/account.php', 'account.html'], ['/family', 'family.html'], ['/family.html', 'family.html'], ['/child.html', 'child.html']]);
const mime = { '.css': 'text/css; charset=utf-8', '.html': 'text/html; charset=utf-8', '.ico': 'image/x-icon', '.js': 'text/javascript; charset=utf-8', '.jpg': 'image/jpeg', '.jpeg': 'image/jpeg', '.png': 'image/png', '.svg': 'image/svg+xml', '.webp': 'image/webp' };
function file(req, res, target) { fs.readFile(target, (error, data) => { if (error) { res.writeHead(404, { 'Content-Type': 'text/plain; charset=utf-8' }); return res.end('Not found'); } res.writeHead(200, { 'Content-Type': mime[path.extname(target)] || 'application/octet-stream', 'Cache-Control': path.extname(target) === '.html' ? 'no-cache' : 'public, max-age=86400', 'X-Content-Type-Options': 'nosniff', 'X-Frame-Options': 'SAMEORIGIN', 'Referrer-Policy': 'strict-origin-when-cross-origin' }); req.method === 'HEAD' ? res.end() : res.end(data); }); }
